/*
 * This is the Server class. Thsi class Runs in the beginning prior to client class to make connection with the client.
 */
package GUI;
...
public class GameServerMain {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        PoacketBeastGUI GamePlayer1 = new PoacketBeastGUI(player, true);
        GamePlayer1.setVisible(true);
        final ExecutorService service = Executors.newCachedThreadPool();
        String message = "";
        Player GamePlayer2;
        try {
            GamePlayer1.socket = new ServerSocket(PORT);     // using the port
            while (true) {
                GamePlayer1.s = GamePlayer1.socket.accept();
                ...
                while (true) {
                    ...
                    if (c == Player.class) {   // reading object passed from socket as Player class
                        GamePlayer2 = (Player) object;
                        GamePlayer1.OpponentPlayer = GamePlayer2;
                        ...
                        JPanel p2 = GamePlayer1.formatLabel(message);
