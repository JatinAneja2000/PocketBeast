...
public class GameBegins {
    ...
    public static GameBegins instance;
    public GameBegins(){
        
    }
    // instance

    // This is where i had Applied  SingleTon Design pattern, This game creats only a single instance for the cose application
    public GameBegins getInstance() {
        if(GameBegins.instance == null){
            if(GameBegins.instance == null){
                GameBegins.instance = new GameBegins();
                letsPlay(); // call to the game
            }
        }
        return GameBegins.instance;
    }
    /**
    ...
    public void letsPlay(){
        ...
        Player[] players = new Player[] {
            new Player("Jatin", new Deck(getStarterDeck())),
            new Player("Yash", new Deck(getStarterDeck()))
        }; 
